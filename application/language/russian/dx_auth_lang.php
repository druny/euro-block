...
$lang['auth_login_incorrect_password'] = "Неправильный логин/пароль.";
$lang['auth_login_username_not_exist'] = "Неправильный логин/пароль.";

$lang['auth_username_or_email_not_exist'] = "Данный e-mail отсутствует в базе";
$lang['auth_not_activated'] = "Your account hasn't been activated yet. Please check your email.";
$lang['auth_request_sent'] = "Запрос уже был направлен. Пожалуйста, проверьте свою почту";
$lang['auth_incorrect_old_password'] = "Вы указали неправильный старый пароль.";
