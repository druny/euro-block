			...
			<div class="container">
				...
				<div class="product-info col-lg-3 col-md-3 col-sm-6 col-xs-6">
					<table>
						...
						<tr>
							<td><p>теплопроводность:</p></td>
						</tr>
						<tr>
							<td><p>водопоглощение:</p></td>
						</tr>
						<tr>
							<td><p>кол-во штук на поддоне</p></td>
						</tr>
						<tr>
							<td><p>морозостойкость:</p></td>
						</tr>
						<tr>
							<td><p>огнестойкость, часы</p></td>
						</tr>
						<tr>
							<td><p>цена за 1 шт.:</p></td>
						</tr>
						<tr>
							<td><p>купить сумма: 0</p></td>
						</tr>
					</table>
				</div>
				...
				<form action="/blocks/cart_add" method="post" class="product-item">
					...
					<table>
						...
						<tr>
							<td><p><?= $product->weight; ?> мм.</p></td>
						</tr>
						<tr>
							<td><p><?= $product->average_density; ?> кг/м³</p></td>
						</tr>
						<tr>
							<td><p><?= $product->size; ?> мм.</p></td>
						</tr>
						<tr>
							<td><p><?= $product->transcalency; ?> Вт/м0С</p></td>
						</tr>
						<tr>
							<td><p><?= $product->water_absorption; ?>%</p></td>
						</tr>
						<tr>
							<td><p><?= $product->pallets; ?></p></td>
						</tr>
						<tr>
							<td><p><?= $product->frost_resistance; ?></p></td>
						</tr>
						<tr>
							<td><p><?= $product->fire_resistance; ?></p></td>
						</tr>
						<tr>
