...
-- Дамп структуры для таблица euro-block.members_type
...
-- Дамп данных таблицы euro-block.members_type: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица euro-block.type_of_ownership
...
-- Дамп данных таблицы euro-block.type_of_ownership: ~3 rows (приблизительно)
...
INSERT INTO `users` (`id`, `ip_address`, `ownership_type_id`, `username`, `passport`, `member_type`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `registration_place`, `issued_by`, `legal_address`) VALUES
	(1, '127.0.0.1', NULL, 'administrator', NULL, NULL, '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1472129995, 1, 'Admin', 'istrator', 'ADMIN', '0', NULL, NULL, NULL),
	(3, '127.0.0.1', NULL, 'geralt777', NULL, NULL, '$2y$08$CgJoPNEvk8EJLHT5EW.89OdGarn6zM8rUtLOBfjMT1ioiCnI0g.XG', NULL, 'geralt@from.rivia', NULL, NULL, NULL, NULL, 1470668133, 1470677159, 1, 'Geralt', 'Rivia', 'Kaer Morhen', '0988123123', NULL, NULL, NULL);
