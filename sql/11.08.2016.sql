...
-- Dumping data for table euro-block.blocks: ~6 rows (approximately)
DELETE FROM `blocks`;
...
-- Dumping data for table euro-block.ordered_products: ~27 rows (approximately)
...
-- Dumping data for table euro-block.orders: ~21 rows (approximately)
DELETE FROM `orders`;
...
INSERT INTO `orders` (`id`, `delivery_date`, `city`, `user_id`, `street`, `paid`, `blocks_shipped`, `blocks_left`, `pallets_shipped`, `pallets_left`, `locality`, `crane`, `payment_type`, `sum`, `is_active`, `is_done`, `manager_id`, `order_date`) VALUES
	...
	(27, '2016-08-18', 'Ривия', 1, 'Советская', 0, NULL, NULL, NULL, NULL, 'Миерин', 1, 'score', 20868, 1, 0, 1, '2016-08-09 22:55:55');
...
INSERT INTO `products` (`id`, `block_id`, `name`, `price`, `weight`, `average_density`, `size`, `transcalency`, `water_absorption`, `pallets`, `frost_resistance`, `fire_resistance`) VALUES
	...
	(4, 2, 'андезитобазальтовый M35', 35, 9.5, 1390, '390×90×188', 0, 8.79, 144, '-', 0.75),
	(5, 3, 'с пенополистирольным вкладышем M35', 215, 18.5, 1000, '390×288×188', 0.085, 0, 36, 'F35', 0),
	(6, 4, 'с пенополистирольным вкладышем M35', 245, 21, 1000, '495×288×188', 0.085, 0, 36, 'F35', 0),
	(7, 5, 'с пенополистирольным вкладышем M35', 130, 0, 1000, '190×288×188', 0.085, 0, 72, 'F35', 0),
	(8, 6, 'андезитобазальтовые', 370, 0, 0, '910х300х180', 0, 0, 0, '-', 0),
	(9, 7, 'андезитобазальтовый М50', 33, 15, 1050, '390×190×188', 0.35, 8.79, 72, 'F50', 0),
	(10, 8, 'тротуарная фигурная "Волна"', 690, 0, 0, '225×125×80', 0, 0, 0, '-', 0),
	(11, 8, 'тротуарная прямоугольная', 670, 0, 0, '260×85×60', 0, 0, 0, '-', 0),
	(12, 8, '«Старый город»', 570, 0, 0, '180×120×60', 0, 0, 0, '-', 0),
	(13, 8, '"Квадрат"', 535, 0, 0, '120×120×60', 0, 0, 0, '-', 0),
	(14, 9, 'Тротуарный', 180, 22, 0, '600х200х80', 0, 0, 60, '-', 0),
	(15, 9, 'Дорожный', 620, 90, 0, '900x300x150', 0, 0, 90, '-', 0),
	(16, 10, 'Порода: базальт, андезитобазальт', 650, 0, 0, NULL, 0, 0, 0, '-', 0);
...
-- Dumping data for table euro-block.status: ~0 rows (approximately)
DELETE FROM `status`;
...
-- Dumping data for table euro-block.users: ~0 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
	(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1470919615, 1, 'Admin', 'istrator', 'ADMIN', '0'),
...
-- Dumping data for table euro-block.users_groups: ~0 rows (approximately)
